...
//    [_photoButton setImage:[UIImage imageNamed:@"EaseUIResource.bundle/chatBar_colorMore_photoSelected"] forState:UIControlStateHighlighted];
    [_photoButton setImageEdgeInsets:UIEdgeInsetsMake(0, 10, 20, 10)];
    [_photoButton setTitleEdgeInsets:UIEdgeInsetsMake(45, -CHAT_BUTTON_SIZE/2 - 25, 0, 0)];
    [_photoButton setImage:[UIImage imageNamed:@"输入框图标-图片未点击"] forState:UIControlStateNormal];
...
//    [_locationButton setImage:[UIImage imageNamed:@"EaseUIResource.bundle/chatBar_colorMore_locationSelected"] forState:UIControlStateHighlighted];
    [_locationButton setImage:[UIImage imageNamed:@"输入框图标-位置"] forState:UIControlStateNormal];
    [_locationButton setImageEdgeInsets:UIEdgeInsetsMake(0, 10, 20, 10)];
    [_locationButton setTitleEdgeInsets:UIEdgeInsetsMake(45, -CHAT_BUTTON_SIZE/2 - 25, 0, 0)];
    //    [_photoButton setImage:[UIImage imageNamed:@"输入框图标-图片未点击"] forState:UIControlStateNormal];
...
//    [_takePicButton setImage:[UIImage imageNamed:@"EaseUIResource.bundle/chatBar_colorMore_cameraSelected"] forState:UIControlStateHighlighted];
    [_takePicButton setImage:[UIImage imageNamed:@"输入框-拍摄未点击"] forState:UIControlStateNormal];
    [_takePicButton setImageEdgeInsets:UIEdgeInsetsMake(0, 10, 20, 10)];
    [_takePicButton setTitleEdgeInsets:UIEdgeInsetsMake(45, -CHAT_BUTTON_SIZE/2 - 25, 0, 0)];
...
//    if (type == EMChatToolbarTypeChat) {
    ...
    [_fileButton setFrame:CGRectMake(insets ,50 + 30, CHAT_BUTTON_SIZE , CHAT_BUTTON_SIZE)];
    [_fileButton setImage:[UIImage imageNamed:@"输入框-发送文件未点击"] forState:UIControlStateNormal];
    [_fileButton addTarget:self action:@selector(takeAudioCallAction) forControlEvents:UIControlEventTouchUpInside];
    _fileButton.tag = MOREVIEW_BUTTON_TAG + 3;
    [_fileButton setImageEdgeInsets:UIEdgeInsetsMake(0, 10, 20, 10)];
    [_fileButton setTitleEdgeInsets:UIEdgeInsetsMake(45, -CHAT_BUTTON_SIZE/2 - 25, 0, 0)];
    [_fileButton setTitle:@"发送文件" forState:UIControlStateNormal];
    [_fileButton setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    _fileButton.titleLabel.font = [UIFont systemFontOfSize:12];
...
//        [_videoCallButton setImage:[UIImage imageNamed:@"EaseUIResource.bundle/chatBar_colorMore_videoCallSelected"] forState:UIControlStateHighlighted];
    ...
    [_videoCallButton setImageEdgeInsets:UIEdgeInsetsMake(0, 10, 20, 10)];
    [_videoCallButton setTitleEdgeInsets:UIEdgeInsetsMake(45, -CHAT_BUTTON_SIZE/2 - 25, 0, 0)];
    ...
    [_videoCallButton setImage:[UIImage imageNamed:@"输入框-视频点击"] forState:UIControlStateNormal];
